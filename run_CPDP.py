...
# load configuration
cfg = get_config('config/config_CPDP.yaml')
os.environ['CUDA_VISIBLE_DEVICES'] = '0'
device = torch.device('cuda:0' if torch.cuda.is_available() else 'cpu')


# Embedding according to the full label of the project is used for cross-project defect prediction
...
def train_and_test(source_project, target_project, mode):
    ...
    save_path = './results_CPDP/' + source_project + '_to_' + target_project
...
# Execute  projects
dict_file = open('Subject_CPDP.csv', 'r')  # Subject_CPDP.csv  file can be edited to set up  CPDP tasks
